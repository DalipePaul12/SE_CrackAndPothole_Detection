      ...
      <div className="admin-container">
        ...
        <div className="admin-summary">
          ...
          <div className="admin-summary-card total">
            <h3>
              Total Reports <GiBookCover className="icon" />
            </h3>
            <p>{summary.total}</p>
          </div>
          ...
          <div className="admin-summary-card pending">
            <h3>
              Resolved <IoMdCheckmarkCircleOutline className="icon" />
            </h3>
          ...
          <div className="admin-summary-card progress">
            <h3>
              Critical Reports <FaExclamationCircle className="icon" />
            </h3>
          ...
          <div className="admin-summary-card completed">
            <h3>
              Non-Critical Reports <FaExclamation className="icon" />
            </h3>
        ...
        <div className="admin-grid">
          ...
          <div className="admin-panel">
            <h3>
              Status Summary <IoBarChart className="icon" />
            </h3>
          ...
          <div className="admin-panel">
            <h3>
              Recent Activities <LuActivity className="icon" />
            </h3>

            <ul className="admin-activity-list">
              {recentActivities.map((item, index) => (
                <li key={index} className="admin-activity-card">
          ...
          <div className="admin-panel-damagecategories">
            <h3>
              Damage Categories <FaChartPie className="icon" />
            </h3>
